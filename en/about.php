...
<div id="divBoxed" class="container">
                ...
                <div class="span12">
                    ...
                    <div class="navbar">
                        ...
                        NAVIGATION<span class="icon-chevron-down icon-white"></span>
                            ...
                            <li class="active"><a href="about.php" style="font-family: 'Poppins', sans-serif !important;">About Us</a></li>
							<!--<li class="dropdown">
    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
            ...
            <div class="breadcrumbs">
                <a href="index.php">Company</a> &nbsp;/&nbsp; <span>About Us</span>
            </div>
			...
			<!--Edit Main Content Area here-->
                <div class="span8" id="divMain" style="width: 100%;">
                    <left>
                    <h1 style="width: 23%;text-align: center;" class="borde-titulo">About Us</h1>
                    </left>
                    <div class="timeline-container" id="timeline-1">
  <div class="timeline-header">
    <h2 class="timeline-header__title">Our History</h2>
    <h3 class="timeline-header__subtitle" style="font-family: 'Poppins', sans-serif !important;font-weight: bold;letter-spacing: 1px;font-size: 22px;color: black;">Innovative Logistics</h3>
  </div>
  <div class="timeline">
    <div class="timeline-item" data-text="Foundation - Beginnings">
      <div class="timeline__content"><img class="timeline__img" src="images/backgroundtruck1.png"/>
        ...
        <p class="timeline__content-desc" style="font-family: 'Poppins', sans-serif !important;font-size: 14px;color: white;">Transportes Norte is a family-owned company founded in 2008.</p>
      </div>
    </div>
    <div class="timeline-item" data-text="Fleet Expansion">
      <div class="timeline__content"><img class="timeline__img" src="images/northzone.png"/>
        <h2 class="timeline__content-title">2009</h2>
        <p class="timeline__content-desc" style="font-family: 'Poppins', sans-serif !important;font-size: 14px;color: white;">Fleet expansion throughout the north of our country.</p>
      </div>
    </div>
    <div class="timeline-item" data-text="Fleet Expansion">
      <div class="timeline__content"><img class="timeline__img" src="images/southzone.png"/>
        <h2 class="timeline__content-title">2010</h2>
        <p class="timeline__content-desc" style="font-family: 'Poppins', sans-serif !important;font-size: 14px;color: white;">Fleet expansion throughout the South of our country.</p>
      </div>
    </div>
    <div class="timeline-item" data-text="Solutions Development">
      <div class="timeline__content"><img class="timeline__img" src="images/eolic.png"/>
        <h2 class="timeline__content-title">2013</h2>
        <p class="timeline__content-desc" style="font-family: 'Poppins', sans-serif !important;font-size: 14px;color: white;">Leasing of services associated with logistics, distribution by land of inputs for renewable energy projects (wind, solar energy) as well as hazardous cargo, making these services our specialty.</p>
      </div>
    </div>
    <div class="timeline-item" data-text="Fleet and Cargo Management and Monitoring">
      <div class="timeline__content"><img class="timeline__img" src="images/gpsmonitor.png"/>
        <h2 class="timeline__content-title">2017</h2>
        <p class="timeline__content-desc" style="font-family: 'Poppins', sans-serif !important;font-size: 14px;color: white;">Implementation of automated GPS. Our platform allows on-line monitoring, creating historical records, speed alarms 24H/day 365 days/year, which is available to our customers whenever they want.</p>
      </div>
    </div>
    <div class="timeline-item" data-text="Digitalization - ERP">
      <div class="timeline__content"><img class="timeline__img" src="images/erpapp.png"/>
        <h2 class="timeline__content-title">2020</h2>
        <p class="timeline__content-desc" style="font-family: 'Poppins', sans-serif !important;font-size: 14px;color: white;">We incorporate to our company powerful ERP centralizing all the information of our internal processes as the processes of a service. You will be able to visualize in real time the details of our carriers.</p>
      </div>
    </div>
    <!--
 ...
 <left>
					<hr>
					<h3 style="font-family: 'Poppins', sans-serif !important;font-weight: bold;color: white;font-size: 40px;text-shadow: 2px 3px black;background: #F65600;border-radius: 19px;width: 33%;" class="borde-titulo">Our Vision</h3>
                    <p>To be a leading organization in integral logistics services, recognized worldwide for its ability to innovate, adapt and respond fully to the needs of its various types of customers.  </p>

                    <h3 style="font-family: 'Poppins', sans-serif !important;font-weight: bold;color: white;font-size: 40px;text-shadow: 2px 3px black;background: #F65600;border-radius: 19px;width: 33%;" class="borde-titulo">Our Mission</h3>
                       <p></p>Develop and elaborate a solid and innovative integrated logistics chain, of the highest quality, which contribute to improve the services and/or production of our customers.</p>
			</left>
