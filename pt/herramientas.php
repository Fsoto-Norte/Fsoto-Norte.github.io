            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div id="divLogo" class="pull-left">
                        ...
                        <a href="index.php" id="divTagLine">Logística inovadora para <stronger class="subtitlelogo">cargas complexas</stronger></a>
					<div class="btn-group">
                    ...
                    <div class="navbar" style="display:block !important;box-shadow: none !important;">
                       ...
                       NAVEGAÇÃO <span class="icon-chevron-down icon-white"></span>
					    	...
					    	<li class="active"><a href="herramientas.php" style="font-family: 'Poppins', sans-serif !important;">Ferramentas</a></li>
                   ...
                   <li>
                    ...
                    <li>
                        <a onclick="send('contenedores')">
                            ...
                            Contentores de transporte aéreo
                        </a>
                             </li>
							  <li>
