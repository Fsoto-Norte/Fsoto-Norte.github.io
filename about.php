...
<head>
    ...
    <link href="styles/custom.css" rel="stylesheet" type="text/css" />
     <link href="styles/cards.css" rel="stylesheet" type="text/css" />
    <link href="styles/wasap.css" rel="stylesheet" type="text/css" />
    ...
    <div class="divPanel notop nobottom">
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="navbar">
                        <button type="button" class="btn-navbar-highlight btn-large btn-primary" data-toggle="collapse" data-target=".nav-collapse" style="font-size:17.5px">
                        NAVEGACIÓN <span class="icon-chevron-down icon-white"></span>
                            ...
                            <li class="active"><a href="about.php" style="font-family: 'Poppins', sans-serif !important;">Nosotros</a></li>
							<!--<li class="dropdown">
    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
            ...
            <div class="breadcrumbs">
                <a href="index.php">Empresa</a> &nbsp;/&nbsp; <span>Nosotros</span>
            </div>

            <div class="row-fluid">
			<!--Edit Main Content Area here-->
                <div class="span8" id="divMain" style="width: 100%;">
                    <left>
                    <h1 style="width: 23%;text-align: center;margin-bottom:10px" class="borde-titulo">Nosotros</h1>
                    </left>
                    <div class="timeline-container" id="timeline-1">
  <div class="timeline-header">
    <h2 class="timeline-header__title">Nuestra Historia</h2>
    <h3 class="timeline-header__subtitle" style="font-family: 'Poppins', sans-serif !important;font-weight: bold;letter-spacing: 1px;font-size: 22px;color: black;">Logistica Innovadora</h3>
  </div>
  <div class="timeline">
    <div class="timeline-item" data-text="Fundación - Inicios">
      <div class="timeline__content"><img class="timeline__img" src="images/backgroundtruck1.png"/>
        <h2 class="timeline__content-title">2008</h2>
        <p class="timeline__content-desc" style="font-family: 'Poppins', sans-serif !important;font-size: 14px;color: white;">Transportes Norte es una empresa familiar fundada en el año 2008.</p>
      </div>
    </div>
    <div class="timeline-item" data-text="Expansión de Flota">
      <div class="timeline__content"><img class="timeline__img" src="images/northzone.png"/>
        <h2 class="timeline__content-title">2009</h2>
        <p class="timeline__content-desc" style="font-family: 'Poppins', sans-serif !important;font-size: 14px;color: white;">Expansión de Flota por todo el Norte de nuestro país.</p>
      </div>
    </div>
    <div class="timeline-item" data-text="Expansión de Flota">
      <div class="timeline__content"><img class="timeline__img" src="images/southzone.png"/>
        <h2 class="timeline__content-title">2010</h2>
        <p class="timeline__content-desc" style="font-family: 'Poppins', sans-serif !important;font-size: 14px;color: white;">Expansión de Flota por todo el Sur de nuestro país.</p>
      </div>
    </div>
    <div class="timeline-item" data-text="Desarrollo de Soluciones">
      <div class="timeline__content"><img class="timeline__img" src="images/eolic.png"/>
        <h2 class="timeline__content-title">2013</h2>
        <p class="timeline__content-desc" style="font-family: 'Poppins', sans-serif !important;font-size: 14px;color: white;">Arriendo de servicios asociados a la logística, distribución por vía terrestre de insumos para proyectos de energías renovables (Eólicos, energía solar) así como de cargas peligrosas, haciendo de estos servicios nuestra especialidad.</p>
      </div>
    </div>
    <div class="timeline-item" data-text="Gestión y Monitoreo de Flota y Carga">
      <div class="timeline__content"><img class="timeline__img" src="images/gpsmonitor.png"/>
        <h2 class="timeline__content-title">2017</h2>
        <p class="timeline__content-desc" style="font-family: 'Poppins', sans-serif !important;font-size: 14px;color: white;">Implementación de GPS automatizado. Nuestra plataforma permite el monitoreo on-line, crear registros históricos, alarmas de velocidad las 24H/día los 365 días/año, la cual está a disposición de nuestros clientes en el momento que lo deseen.</p>
      </div>
    </div>
    <div class="timeline-item" data-text="Digitalización - ERP">
      <div class="timeline__content"><img class="timeline__img" src="images/erpapp.png"/>
        <h2 class="timeline__content-title">2020</h2>
        <p class="timeline__content-desc" style="font-family: 'Poppins', sans-serif !important;font-size: 14px;color: white;">Incorporamos a nuestra compañía potente ERP centralizando toda la información de nuestros procesos internos como los procesos de un servicio. Podrás visualizar en tiempo real el detalle de nuestros transportes.</p>
      </div>
    </div>
    <!--
    <div class="timeline-item" data-text="Digitalización - ERP">
      <div class="timeline__content"><img class="timeline__img" src="http://manisanokta.com/wp-content/uploads/2014/07/ataturk-20.jpg"/>
        <h2 class="timeline__content-title">2020</h2>
        <p class="timeline__content-desc">Incorporamos a nuestra compañía potente ERP centralizando toda la información de nuestros procesos internos como los procesos de un servicio. Podrás visualizar en tiempo real el detalle de nuestros transportistas.</p>
      </div>
    </div>
    ...
    -->
                    ...
                    <left>
					<hr>
					<h3 style="font-family: 'Poppins', sans-serif !important;font-weight: bold;color: white;font-size: 40px;text-shadow: 2px 3px black;background: #F65600;border-radius: 19px;width: 33%;" class="borde-titulo">Nuestra Visión</h3>
                    <p>Ser una organización líder en servicios de logística integral, reconocidos a nivel internacional por su capacidad de innovar, adaptar y responder plenamente a las necesidades de sus diversos tipos de clientes. </p>

                    <h3 style="font-family: 'Poppins', sans-serif !important;font-weight: bold;color: white;font-size: 40px;text-shadow: 2px 3px black;background: #F65600;border-radius: 19px;width: 33%;" class="borde-titulo">Nuestra Misión</h3>
                       <p></p>Desarrollar y elaborar una cadena de logística integral sólida e  innovadora, de la más alta calidad, que contribuyan a mejorar los servicios y/o  producción de nuestros clientes. </p>
										 </left>
